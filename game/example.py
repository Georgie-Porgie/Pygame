...
player = pygame.image.load("Users\George\Desktop\HYPERION\Introduction to Programming\Task 15\game\image.png")
enemy = pygame.image.load("Users\George\Desktop\HYPERION\Introduction to Programming\Task 15\game\enemy.png")
...
image_height = player.get_height(1)
image_width = player.get_width(1)
enemy_height = enemy.get_height(1)
enemy_width = enemy.get_width(1)
